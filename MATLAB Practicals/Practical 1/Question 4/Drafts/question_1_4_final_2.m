% This is a simple program that estimates the total daily cost and total city's cost of transport
...
% Prompts user to enter the city's average daily distance driven by fuel-powered cars
averageDailyDistance = input("What is the average daily distance driven in the city in kilometers (e.g. 35) ");

% Prompts user to estimate the average fuel cost per year of the city
fuelCost = input("What would you estimate your city's average daily fuel cost to be in dollars per liter (e.g. 1.8)? ");

% Prompts user to enter the percentage of the city that drives a fuel-powered car
...
costPerDay = averageDailyDistance * fuelCost * percentageFuelCars;

% Prompts user to enter average yearly cost of registration of the city and converts to daily cost by dividing by 365
...
totalDailyCost = registration + costPerDay;

% Calculates total daily city cost of fuel-powered cars
totalCityCost = totalDailyCost * population * percentageFuelCars;

% Prints estimated daily cost for those driving fuel-powered cars
fprintf("The average total daily transportation cost for individuals who drive fuel-powered cars in the city is $%.2f, including registration costs.\n", totalDailyCost);

% Prints the estimated total city's cost of the city for fuel-powered cars per day
fprintf("The city's average total daily transportation cost from fuel-powered cars with a population of %i is $%.2f, including registration costs.", population, totalCityCost);
