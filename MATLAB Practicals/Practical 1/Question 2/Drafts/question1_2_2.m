...
% city in kilolitres based on its population and rough estimates of
% household size and daily water usage of the city.
...
water = water_per_house * population / household_size / 1000;

% Prints the approximate daily water usage of the city

fprintf("The approximate total daily household water use of %s in kilolitres is %f", city, water)