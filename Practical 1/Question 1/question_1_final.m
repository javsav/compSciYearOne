...
while height < 0
    height = input ("Please enter a numeral greater than or equal to zero: ");
end
...
while length < 0
    length = input ("Please enter a numeral greater than or equal to zero: ");
end
...
while depth < 0
    depth = input ("Please enter a numeral greater than or equal to zero: ");
end
