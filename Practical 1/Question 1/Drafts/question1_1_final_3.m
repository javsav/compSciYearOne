...
% Nested if statements to deter the user from entering unnatural numbers
% for height
...
if height < 0
    ...
    if height < 0
        height = input("Entering a natural number is recommended, please do so ");
    end
end
...
if length < 0
    ...
    if length < 0
        length = input("Entering a natural number is recommended, please do so ");
    end
end
...
if depth < 0
    ...
    if depth < 0
        depth = input("Entering a natural number is recommended, please do so ");
    end
end
