...
fprintf("The total daily transportation cost for individuals who drive fuel powered cars in a city with a population of %s is %.2f dollars assuming fifty percent of the population drive cars, including registration costs",int2words(population),totalDailyCost/population/2)
