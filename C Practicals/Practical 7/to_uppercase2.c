 ...
 * string represents a person's name, and can only comprise letters (lower and
 * upper case) and commas (the commas are to separate names, and count as a
 * character). After reading the string, the program converts the string to all
 * uppercase letters and prints it, followed by a newline. Comma characters are
 * left unchanged. */
...
int main() {
  ...
  printf(
      ...
      "character limit including commas is 20.\nOnly letters (both upper and "
      "lower case) and commas are valid forms of input.\nNo spaces or special "
      "characters other than commas are allowed.\nEntries longer than 20 "
      "characters will be truncated.\nAn example of a correct format is as "
      "follows: 'Jason,Smith' .\nPlease enter your first name and last name, "
      "separated by a comma, all in lowercase as per the example: ");
